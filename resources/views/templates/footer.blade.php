                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget">
                            ...
                            <p class="description mt--20">Yeldan Tech, yeni teknolojileriyle müşterilerine harika SEO hizmetleri vermeyi hedefler.</p>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget">
                            ...
                            <ul class="ft-link">
                                <li class="mb-4">
                                    <a href="contact.html">Lorem ipsum dolor sit amet consectetur.</a>
                                </li>
                                <li class="mb-4">
                                    <a href="become-a-teacher.html">Lorem ipsum dolor sit amet consectetur adipisicing elit.</a>
                                </li>
                                <li class="mb-4">
                            ...
                            <form class="newsletter-form mt--40" action="#">
                                ...
                                <div class="form-group mb--0">
                                    <button class="rbt-btn rbt-switch-btn btn-gradient radius-round btn-sm" type="submit">
                                        <span data-text="Submit Now">Gönder</span>
                                    </button>
                                </div>
                            </form>
                        </div>
