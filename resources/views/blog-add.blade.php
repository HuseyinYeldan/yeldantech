...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KVLKZ553"
    ...
    <div class="container">
        <div class="row g-5 align-items-center mt--50 mb--50">
            ...
            <form action="/blog-paylas" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" name="baslik" placeholder="Başlık..." required class="inputBlogTitle" maxlength="80" minlength="10">
                <input type="text" name="aciklama" placeholder="Blog Açıklaması..." required class="inputBlogTitle" maxlength="155" minlength="10">
                <input type="text" name="slug" placeholder="Blog url (harika-blog-basligim)" required class="inputBlogTitle" maxlength="80" minlength="10" pattern="[a-zA-Z0-9-]+">

                <select name="category" id="category" class="mb--20">
                    <option value="diger" disabled selected hidden>Kategori Seç</option>
                ...
                <div class="inputImageBox">
                    ...
                    <img id="inputImageBoxPlaceholder" src="https://placehold.co/1920x1080" alt="your image"/>
                </div>

                <textarea name="content" required id="blogEkle"></textarea>
