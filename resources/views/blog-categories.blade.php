        ...
        <div class="container">
            ...
            <div class="row row--15">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--20" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <!-- Start Single Card  -->
                    @foreach ($blogCat->sortByDesc('created_at')->slice(1,3) as $blog)
            ...
            <div class="row g-5 mt--15">
                ...
                @foreach ($blogCat->sortByDesc('created_at')->slice(4) as $blog)
                ...
                <div class="col-lg-12 mt--60">
                    <nav>
                        <ul class="rbt-pagination">
                            ...
                            @if ($blogCat->onFirstPage())
                                <li class="disabled"><a href="#" aria-label="Previous"><i class="feather-chevron-left"></i></a></li>
                            @else
                                <li><a href="{{ $blogCat->previousPageUrl() }}" aria-label="Previous"><i class="feather-chevron-left"></i></a></li>
                            @endif
            
                            <!-- Numbered Pages -->
                            @foreach ($blogCat->getUrlRange(1, $blogCat->lastPage()) as $page => $url)
                                @if ($page == $blogCat->currentPage())
                            ...
                            <!-- Next Page Button -->
                            @if ($blogCat->hasMorePages())
                                <li><a href="{{ $blogCat->nextPageUrl() }}" aria-label="Next"><i class="feather-chevron-right"></i></a></li>
                            @else
